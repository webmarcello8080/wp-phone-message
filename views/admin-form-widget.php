...
<div class="wrap">
      ...
      <form class="wp-phone-message-form" method="post" action="<?php echo esc_html( admin_url( 'admin-post.php' ) ); ?>?">
            ...
            <h1 class="admin-page-title"><?php echo __( 'Managing Form Generated on the Widget', 'my-phone-message-wp' ); ?></h1>
                        ...
                        <tr>
                              ...
                              <td>
                                    <input type="checkbox" id="wp-phone-message-name-active-widget"
                                          ...
                                          <?php echo ( get_option('wp-phone-message-name-active-widget') ? 'checked' : ''); ?>
                                          value="1">
                              ...
                              <td>
                                    <input type="checkbox" id="wp-phone-message-name-mandatory-widget"
                                          ...
                                          <?php echo ( get_option('wp-phone-message-name-mandatory-widget') ? 'checked' : ''); ?>
                                          value="required">
                              ...
                              <td>
                                    <input name="wp-phone-message-name-widget" type="text" id="wp-phone-message-name-widget"
                                          value="<?php echo get_option('wp-phone-message-name-widget'); ?>" class="regular-text" />
                        ...
                        <tr>
                              ...
                              <td>
                                    <input type="checkbox" id="wp-phone-message-phone-active-widget"
                                          ...
                                          <?php echo ( get_option('wp-phone-message-phone-active-widget') ? 'checked' : ''); ?>
                                          value="1">
                              ...
                              <td>
                                    <input type="checkbox" id="wp-phone-message-phone-mandatory-widget"
                                          ...
                                          <?php echo ( get_option('wp-phone-message-phone-mandatory-widget') ? 'checked' : ''); ?>
                                          value="required">
                              ...
                              <td>
                                    <input name="wp-phone-message-phone-widget" type="text" id="wp-phone-message-phone-widget"
                                          value="<?php echo get_option('wp-phone-message-phone-widget'); ?>" class="regular-text" />
                        ...
                        <tr>
                              ...
                              <td>
                                    <input type="checkbox" id="wp-phone-message-extra-active-widget"
                                          ...
                                          <?php echo ( get_option('wp-phone-message-extra-active-widget') ? 'checked' : ''); ?>
                                          value="1">
                              ...
                              <td>
                                    <input type="checkbox" id="wp-phone-message-extra-mandatory-widget"
                                          ...
                                          <?php echo ( get_option('wp-phone-message-extra-mandatory-widget') ? 'checked' : ''); ?>
                                          value="required">
                              ...
                              <td>
                                    <input name="wp-phone-message-extra-widget" type="text" id="wp-phone-message-extra-widget"
                                          value="<?php echo get_option('wp-phone-message-extra-widget'); ?>" class="regular-text" />
                        ...
                        <tr>
                              ...
                              <td>
                                    <input type="checkbox" id="wp-phone-message-email-active-widget"
                                          ...
                                          <?php echo ( get_option('wp-phone-message-email-active-widget') ? 'checked' : ''); ?>
                                          value="1">
                              ...
                              <td>
                                    <input type="checkbox" id="wp-phone-message-email-mandatory-widget"
                                          ...
                                          <?php echo ( get_option('wp-phone-message-email-mandatory-widget') ? 'checked' : ''); ?>
                                          value="required">
                              ...
                              <td>
                                    <input name="wp-phone-message-email-widget" type="text" id="wp-phone-message-email-widget"
                                          value="<?php echo get_option('wp-phone-message-email-widget'); ?>" class="regular-text" />
                        ...
                        <tr>
                              ...
                              <td>
                                    <input type="checkbox" id="wp-phone-message-dropdown-active-widget"
                                          ...
                                          <?php echo ( get_option('wp-phone-message-dropdown-active-widget') ? 'checked' : ''); ?>
                                          value="1">
                              ...
                              <td>
                                    <input type="checkbox" id="wp-phone-message-dropdown-mandatory-widget"
                                          ...
                                          <?php echo ( get_option('wp-phone-message-dropdown-mandatory-widget') ? 'checked' : ''); ?>
                                          value="required">
                              ...
                              <td>
                                    <textarea name="wp-phone-message-dropdown-widget" id="wp-phone-message-dropdown-widget"
                                          ...
                                          rows="3"><?php echo get_option('wp-phone-message-dropdown-widget'); ?></textarea>
                        ...
                        <tr>
                              ...
                              <td>
                                    <input name="wp-phone-message-textarea-widget" type="text" id="wp-phone-message-textarea-widget"
                                          value="<?php echo get_option('wp-phone-message-textarea-widget'); ?>"
                                          class="regular-text" />
                        ...
                        <tr>
                              ...
                              <td>
                                    <input name="wp-phone-message-button-widget" type="text" id="wp-phone-message-button-widget"
                                          value="<?php echo get_option('wp-phone-message-button-widget'); ?>" class="regular-text" />
