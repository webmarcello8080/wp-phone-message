...
<div class="wrap">
      ...
      <form  class="wp-phone-message-form" method="post" action="<?php echo esc_html( admin_url( 'admin-post.php' ) ); ?>?">
            ...
            <h1 class="admin-page-title"><?php echo __( 'Managing Form Generated by the Shortcode', 'my-phone-message-wp' ); ?></h1>
            <div class="form-description">
                  In order to display the Whatsapp message form on your page please add the shortcode <b>[my-phone-message-wp]</b> to your page/post content.
            </div>
                        ...
                        <tr>
                              ...
                              <td>
                                    <textarea name="wp-phone-message-text" id="wp-phone-message-text"
                                          ...
                                          rows="3"><?php echo get_option('wp-phone-message-text'); ?></textarea>
                        ...
                        <tr>
                              ...
                              <td>
                                    <input type="checkbox" id="wp-phone-message-name-active"
                                          ...
                                          <?php echo ( get_option('wp-phone-message-name-active') ? 'checked' : ''); ?>
                                          value="1">
                              ...
                              <td>
                                    <input type="checkbox" id="wp-phone-message-name-mandatory"
                                          ...
                                          <?php echo ( get_option('wp-phone-message-name-mandatory') ? 'checked' : ''); ?>
                                          value="required">
                              ...
                              <td>
                                    <input name="wp-phone-message-name" type="text" id="wp-phone-message-name"
                                          value="<?php echo get_option('wp-phone-message-name'); ?>" class="regular-text" />
                        ...
                        <tr>
                              ...
                              <td>
                                    <input type="checkbox" id="wp-phone-message-phone-active"
                                          ...
                                          <?php echo ( get_option('wp-phone-message-phone-active') ? 'checked' : ''); ?>
                                          value="1">
                              ...
                              <td>
                                    <input type="checkbox" id="wp-phone-message-phone-mandatory"
                                          ...
                                          <?php echo ( get_option('wp-phone-message-phone-mandatory') ? 'checked' : ''); ?>
                                          value="required">
                              ...
                              <td>
                                    <input name="wp-phone-message-phone" type="text" id="wp-phone-message-phone"
                                          value="<?php echo get_option('wp-phone-message-phone'); ?>" class="regular-text" />
                        ...
                        <tr>
                              ...
                              <td>
                                    <input type="checkbox" id="wp-phone-message-extra-active"
                                          ...
                                          <?php echo ( get_option('wp-phone-message-extra-active') ? 'checked' : ''); ?>
                                          value="1">
                              ...
                              <td>
                                    <input type="checkbox" id="wp-phone-message-extra-mandatory"
                                          ...
                                          <?php echo ( get_option('wp-phone-message-extra-mandatory') ? 'checked' : ''); ?>
                                          value="required">
                              ...
                              <td>
                                    <input name="wp-phone-message-extra" type="text" id="wp-phone-message-extra"
                                          value="<?php echo get_option('wp-phone-message-extra'); ?>" class="regular-text" />
                        ...
                        <tr>
                              ...
                              <td>
                                    <input type="checkbox" id="wp-phone-message-email-active"
                                          ...
                                          <?php echo ( get_option('wp-phone-message-email-active') ? 'checked' : ''); ?>
                                          value="1">
                              ...
                              <td>
                                    <input type="checkbox" id="wp-phone-message-email-mandatory"
                                          ...
                                          <?php echo ( get_option('wp-phone-message-email-mandatory') ? 'checked' : ''); ?>
                                          value="required">
                              ...
                              <td>
                                    <input name="wp-phone-message-email" type="text" id="wp-phone-message-email"
                                          value="<?php echo get_option('wp-phone-message-email'); ?>" class="regular-text" />
                        ...
                        <tr>
                              ...
                              <td>
                                    <input type="checkbox" id="wp-phone-message-dropdown-active"
                                          ...
                                          <?php echo ( get_option('wp-phone-message-dropdown-active') ? 'checked' : ''); ?>
                                          value="1">
                              ...
                              <td>
                                    <input type="checkbox" id="wp-phone-message-dropdown-mandatory"
                                          ...
                                          <?php echo ( get_option('wp-phone-message-dropdown-mandatory') ? 'checked' : ''); ?>
                                          value="required">
                              ...
                              <td>
                                    <textarea name="wp-phone-message-dropdown" id="wp-phone-message-dropdown"
                                          class="large-text code"
                                          rows="3"><?php echo get_option('wp-phone-message-dropdown'); ?></textarea>
                        ...
                        <tr>
                              ...
                              <td>
                                    <input name="wp-phone-message-textarea" type="text" id="wp-phone-message-textarea"
                                          value="<?php echo get_option('wp-phone-message-textarea'); ?>"
                                          class="regular-text" />
                        ...
                        <tr>
                              ...
                              <td>
                                    <input name="wp-phone-message-button" type="text" id="wp-phone-message-button"
                                          value="<?php echo get_option('wp-phone-message-button'); ?>" class="regular-text" />
