...
if ( !class_exists( 'WpPhoneMessageModel' ) ) {
    ...
    class WpPhoneMessageModel {
        ...
        public function setData($args){
            ...
            $address_place_widget = sanitize_text_field( $args['wp-phone-message-address-widget'] );
            $address_active_widget = sanitize_text_field( $args['wp-phone-message-address-active-widget'] );
            $address_mandatory_widget = sanitize_text_field( $args['wp-phone-message-address-mandatory-widget'] );
            ...
            update_option( 'wp-phone-message-address-widget', $address_place_widget );
            update_option( 'wp-phone-message-address-active-widget', $address_active_widget );
            update_option( 'wp-phone-message-address-mandatory-widget', $address_mandatory_widget );
